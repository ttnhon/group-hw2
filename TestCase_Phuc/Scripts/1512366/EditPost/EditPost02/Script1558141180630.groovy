...
WebUI.setText(findTestObject('Object Repository/Page_Edit Post  Spectrum/textarea1'), '')
...
WebUI.setText(findTestObject('Object Repository/Page_Edit Post  Spectrum/textarea2'), 'Edit Post')
