...
WebUI.click(findTestObject('Object Repository/Page_Edit Post  Spectrum/button_notification-fillSubscribed'))

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/Page_Edit Post  Spectrum/button_notificationNotify me'))
