...
WebUI.click(findTestObject('Object Repository/Page_iEdit Posti  Spectrum/button_private-unlockedLock chat'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_iEdit Posti  Spectrum/button_privateUnlock chat'))
